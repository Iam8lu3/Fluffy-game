        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-[2px]" data-testid="credits-modal">
            <div className="surface-parchment frame-ornate w-[min(620px,92%)] p-8 text-center">
                ...
                <div className="space-y-3 font-dialogue text-[var(--fl-ink)]">
                    <p><span className="font-display uppercase text-xs tracking-[0.25em] text-[var(--fl-blood)]">A note from the writer</span><br/>This is a small game about a cat with an enormous imagination<br/>and the ordinary home that contains him.</p>
                    ...
                    <p><span className="font-display uppercase text-xs tracking-[0.25em] text-[var(--fl-blood)]">Starring</span><br/>Fluffy, as himself.<br/>The Vacuum, in a difficult role.<br/>The Gnome, in silent dignity.</p>
                </div>
