...
import FantasyToggle from '../components/game/FantasyToggle';
...
export default function Game() {
    ...
    // Trigger entry monologue on first load
    useEffect(() => {
                    ...
                    return (
                        <button
                            ...
                            className={`text-left px-3 py-1.5 font-dialogue italic transition-all
                                ${active ? 'bg-[var(--fl-arcane)]/70 text-[var(--fl-candle-soft)] border-l-2 border-[var(--fl-candle)]' :
